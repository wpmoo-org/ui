...
class ButtonTests(CatalogTestCase):
    ...
    def test_button_tooltip_html_renders_composed_markup(self) -> None:
        ...
        # Bootstrap's own tooltip/popover sanitizer still receives the real
        # <kbd> tag; only the outer HTML attribute stays well-formed no
        # matter what the content contains. See
